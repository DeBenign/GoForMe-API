...
const fundWallet = async (req, res) => {
  try {
    ...
    // Set CUSTOMER_APP_URL in .env to your deployed customer app's origin.
    const callbackUrl = process.env.CUSTOMER_APP_URL
      ? `${process.env.CUSTOMER_APP_URL.replace(/\/$/, "")}/wallet`
      : undefined
